...
def load_conv2d_nobn(state_dict, name_pth, name_tf):
    h5f = h5py.File("dump/InceptionResnetV2/" + name_tf + ".h5", "r")
    state_dict[name_pth + ".weight"] = torch.from_numpy(
        h5f["weights"][()]
    ).permute(
        3, 2, 0, 1
    )
...
def load_mixed_5b(state_dict, name_pth, name_tf):
    load_conv2d(
        state_dict, name_pth + ".branch0", name_tf + "/Branch_0/Conv2d_1x1"
    )
    load_conv2d(
        state_dict,
        name_pth + ".branch1.0",
    ...
    load_conv2d(
        state_dict,
        name_pth + ".branch1.1",
        name_tf + "/Branch_1/Conv2d_0b_5x5",
    )
    load_conv2d(
        state_dict,
        name_pth + ".branch2.0",
...
def load_mixed_6a(state_dict, name_pth, name_tf):
    load_conv2d(
        state_dict, name_pth + ".branch0", name_tf + "/Branch_0/Conv2d_1a_3x3"
    )
    load_conv2d(
        state_dict,
        name_pth + ".branch1.0",
...
def load_mixed_7a(state_dict, name_pth, name_tf):
    ...
    load_conv2d(
        state_dict,
        name_pth + ".branch2.2",
        name_tf + "/Branch_2/Conv2d_1a_3x3",
    )
...
def load():
    ...
    for i in range(10):
        load_block35(
            state_dict,
            name_pth="repeat." + str(i),
            name_tf="Repeat/block35_" + str(i + 1),
        )
    ...
    for i in range(20):
        load_block17(
            state_dict,
            name_pth="repeat_1." + str(i),
            name_tf="Repeat_1/block17_" + str(i + 1),
        )
    ...
    for i in range(9):
        load_block8(
            state_dict,
            name_pth="repeat_2." + str(i),
            name_tf="Repeat_2/block8_" + str(i + 1),
        )
